                    ...
                    <Row>
                      <Col xl={9} xs={12} pb={3}>
                        <div className="form-group">
                          ...
                          <input className="form-control" placeholder="E.g. Referral by John Doe, Webinar on xxxxxx (date)" maxlength="30" value={this.state.fields["campaign"]} name="Campaign" onChange={(e) => this.setState({ campaign: e.target.value })} required/>
                        </div>
