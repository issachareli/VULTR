...
const AddCredits = function(props) {
  ...
  const handleAddCredits1 = function(e) {
      e.preventDefault();
  };

    const handleAddCredits = function(e) {
        if(!window.confirm('Are you sure you want to continue ?')) { return false; }
    ...
    return (
        <Form>
         <FormGroup row style={{ alignItems: "center"}}>
            ...
            <Row>
                <Col xs={6}>
                    <Button  size="md" xs={12} color="success" style={{width: '100%'}} data-dismiss="Modal" onClick={handleCancel}>Cancel</Button>
                </Col> 
                <Col xs={6}>
                                    ...
                                    <Row className="px-2 px-lg-3">
                                        ...
                                        <Col xs={12} lg={8}>
                                            ...
                                            <FormGroup row style={{ alignItems: "center"}}>
                                                ...
                                                <Col xs={12}>
                                                    <Input  bsSize="sm" type="select" value={sponsorType} name="sponsorType" onChange={handleFormChange}>
